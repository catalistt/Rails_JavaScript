...
class PhysicalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create physical" do
    assert_difference('Physical.count') do
      post physicals_url, params: { physical: { name: @physical.name, stock: @physical.stock } }
    end
  ...
  test "should update physical" do
    patch physical_url(@physical), params: { physical: { name: @physical.name, stock: @physical.stock } }
