...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { coupon_type: @coupon.coupon_type, discount: @coupon.discount, max_usage: @coupon.max_usage, user_id: @coupon.user_id } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { coupon_type: @coupon.coupon_type, discount: @coupon.discount, max_usage: @coupon.max_usage, user_id: @coupon.user_id } }
