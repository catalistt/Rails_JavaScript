...
ActiveRecord::Schema.define(version: 2020_09_23_004429) do
  ...
  create_table "product_variations", force: :cascade do |t|
    ...
    t.index ["variation_id", "product_id"], name: "index_product_variations_on_variation_id_and_product_id", unique: true
