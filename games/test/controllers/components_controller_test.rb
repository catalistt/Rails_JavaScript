...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference('Component.count') do
      post components_url, params: { component: { game_id: @component.game_id, name: @component.name, quantity: @component.quantity } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { game_id: @component.game_id, name: @component.name, quantity: @component.quantity } }
